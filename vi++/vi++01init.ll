; ModuleID = 'Module vi++01init'
source_filename = "Module vi++01init"
...
@global_string = private constant [9 x i8] c"winsize%\00", align 1
@global_string.1 = private constant [14 x i8] c"vi++01init.nc\00", align 1
@global_string.2 = private constant [9 x i8] c"xgetmaxx\00", align 1
@global_string.3 = private constant [9 x i8] c"xgetmaxx\00", align 1
@global_string.4 = private constant [9 x i8] c"winsize%\00", align 1
@global_string.5 = private constant [14 x i8] c"vi++01init.nc\00", align 1
@global_string.6 = private constant [9 x i8] c"xgetmaxy\00", align 1
@global_string.7 = private constant [9 x i8] c"xgetmaxy\00", align 1
@global_string.8 = private constant [13 x i8] c"list%<int*%>\00", align 1
@global_string.9 = private constant [14 x i8] c"vi++01init.nc\00", align 1
...
@global_string.14 = private constant [15 x i8] c"list%<ViWin*%>\00", align 1
@global_string.15 = private constant [14 x i8] c"vi++01init.nc\00", align 1
@global_string.16 = private constant [11 x i8] c"initialize\00", align 1
@global_string.17 = private constant [14 x i8] c"Vi_initialize\00", align 1
@global_string.18 = private constant [7 x i8] c"ViWin%\00", align 1
@global_string.19 = private constant [14 x i8] c"vi++01init.nc\00", align 1
@global_string.20 = private constant [11 x i8] c"initialize\00", align 1
@global_string.21 = private constant [14 x i8] c"Vi_initialize\00", align 1
@global_string.22 = private constant [4 x i8] c"aaa\00", align 1
@global_string.23 = private constant [18 x i8] c"list_item%<int*%>\00", align 1
@global_string.24 = private constant [28 x i8] c"/usr/local//include/neo-c.h\00", align 1
@global_string.25 = private constant [28 x i8] c"push_back_intp21_vi++01init\00", align 1
@global_string.26 = private constant [33 x i8] c"list_push_back_intp21_vi++01init\00", align 1
@global_string.27 = private constant [18 x i8] c"list_item%<int*%>\00", align 1
@global_string.28 = private constant [28 x i8] c"/usr/local//include/neo-c.h\00", align 1
@global_string.29 = private constant [28 x i8] c"push_back_intp21_vi++01init\00", align 1
@global_string.30 = private constant [33 x i8] c"list_push_back_intp21_vi++01init\00", align 1
@global_string.31 = private constant [18 x i8] c"list_item%<int*%>\00", align 1
@global_string.32 = private constant [28 x i8] c"/usr/local//include/neo-c.h\00", align 1
@global_string.33 = private constant [28 x i8] c"push_back_intp21_vi++01init\00", align 1
@global_string.34 = private constant [33 x i8] c"list_push_back_intp21_vi++01init\00", align 1
@global_string.35 = private constant [4 x i8] c"bbb\00", align 1
...
@global_string.38 = private constant [28 x i8] c"push_back_intp22_vi++01init\00", align 1
@global_string.39 = private constant [33 x i8] c"list_push_back_intp22_vi++01init\00", align 1
...
@global_string.42 = private constant [28 x i8] c"push_back_intp22_vi++01init\00", align 1
@global_string.43 = private constant [33 x i8] c"list_push_back_intp22_vi++01init\00", align 1
...
@global_string.46 = private constant [28 x i8] c"push_back_intp22_vi++01init\00", align 1
@global_string.47 = private constant [33 x i8] c"list_push_back_intp22_vi++01init\00", align 1
@global_string.48 = private constant [4 x i8] c"ccc\00", align 1
...
@global_string.51 = private constant [28 x i8] c"push_back_intp23_vi++01init\00", align 1
@global_string.52 = private constant [33 x i8] c"list_push_back_intp23_vi++01init\00", align 1
...
@global_string.55 = private constant [28 x i8] c"push_back_intp23_vi++01init\00", align 1
@global_string.56 = private constant [33 x i8] c"list_push_back_intp23_vi++01init\00", align 1
...
@global_string.59 = private constant [28 x i8] c"push_back_intp23_vi++01init\00", align 1
@global_string.60 = private constant [33 x i8] c"list_push_back_intp23_vi++01init\00", align 1
@global_string.61 = private constant [20 x i8] c"list_item%<ViWin*%>\00", align 1
@global_string.62 = private constant [28 x i8] c"/usr/local//include/neo-c.h\00", align 1
@global_string.63 = private constant [30 x i8] c"push_back_ViWinp24_vi++01init\00", align 1
@global_string.64 = private constant [35 x i8] c"list_push_back_ViWinp24_vi++01init\00", align 1
@global_string.65 = private constant [20 x i8] c"list_item%<ViWin*%>\00", align 1
@global_string.66 = private constant [28 x i8] c"/usr/local//include/neo-c.h\00", align 1
@global_string.67 = private constant [30 x i8] c"push_back_ViWinp24_vi++01init\00", align 1
@global_string.68 = private constant [35 x i8] c"list_push_back_ViWinp24_vi++01init\00", align 1
@global_string.69 = private constant [20 x i8] c"list_item%<ViWin*%>\00", align 1
@global_string.70 = private constant [28 x i8] c"/usr/local//include/neo-c.h\00", align 1
@global_string.71 = private constant [30 x i8] c"push_back_ViWinp24_vi++01init\00", align 1
@global_string.72 = private constant [35 x i8] c"list_push_back_ViWinp24_vi++01init\00", align 1
...
entry:
  ...
  %2 = call i8* @debug_xcalloc(i64 1, i64 8, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @global_string, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @global_string.1, i32 0, i32 0), i32 5, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @global_string.2, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @global_string.3, i32 0, i32 0))
  %3 = bitcast i8* %2 to %winsize*
  %ws = alloca %winsize*
  %4 = bitcast %winsize** %ws to i8*
  store i8* %4, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 380), align 8
...
entry:
  ...
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
  %2 = call i8* @debug_xcalloc(i64 1, i64 8, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @global_string.4, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @global_string.5, i32 0, i32 0), i32 13, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @global_string.6, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @global_string.7, i32 0, i32 0))
  %3 = bitcast i8* %2 to %winsize*
  %ws = alloca %winsize*
  %4 = bitcast %winsize** %ws to i8*
  store i8* %4, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 380), align 8
...
define %ViWin* @ViWin_initialize(%ViWin* %self, i32 %y, i32 %x, i32 %width, i32 %height) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
  ...
  %7 = call i8* @debug_xcalloc(i64 1, i64 24, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @global_string.8, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @global_string.9, i32 0, i32 0), i32 22, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @global_string.10, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @global_string.11, i32 0, i32 0))
  %8 = bitcast i8* %7 to %list__intp*
  %9 = call %list__intp* @"list_initialize_intp0_vi++01init"(%list__intp* %8)
  %10 = getelementptr inbounds %ViWin, %ViWin* %self6, i32 0, i32 1
  %11 = load %list__intp*, %list__intp** %10, align 8
  %12 = ptrtoint %list__intp* %11 to i64
  %13 = icmp ne i64 %12, 0
...
cond_end:                                         ; preds = %cond_then_block, %entry
  call void @"list_finalize_intp1_vi++01init"(%list__intp* %11)
  %14 = bitcast %list__intp* %11 to i8*
  call void @xfree(i8* %14)
  store %list__intp* %9, %list__intp** %10, align 8
  %self7 = load %ViWin*, %ViWin** %self1, align 8
  %y8 = load i32, i32* %y2, align 4
  %15 = getelementptr inbounds %ViWin, %ViWin* %self7, i32 0, i32 2
  store i32 %y8, i32* %15, align 4
  %self9 = load %ViWin*, %ViWin** %self1, align 8
  %x10 = load i32, i32* %x3, align 4
  %16 = getelementptr inbounds %ViWin, %ViWin* %self9, i32 0, i32 3
  store i32 %x10, i32* %16, align 4
  %self11 = load %ViWin*, %ViWin** %self1, align 8
  %width12 = load i32, i32* %width4, align 4
  %17 = getelementptr inbounds %ViWin, %ViWin* %self11, i32 0, i32 4
  store i32 %width12, i32* %17, align 4
  %self13 = load %ViWin*, %ViWin** %self1, align 8
  %height14 = load i32, i32* %height5, align 4
  %18 = getelementptr inbounds %ViWin, %ViWin* %self13, i32 0, i32 5
  store i32 %height14, i32* %18, align 4
  %self15 = load %ViWin*, %ViWin** %self1, align 8
  %19 = getelementptr inbounds %ViWin, %ViWin* %self15, i32 0, i32 8
  store i32 0, i32* %19, align 4
  %height16 = load i32, i32* %height5, align 4
  %width17 = load i32, i32* %width4, align 4
  %y18 = load i32, i32* %y2, align 4
  %x19 = load i32, i32* %x3, align 4
  %20 = call %_win_st* @newwin(i32 %height16, i32 %width17, i32 %y18, i32 %x19)
  %win = alloca %_win_st*
  %21 = bitcast %_win_st** %win to i8*
  store i8* %21, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 385), align 8
  store %_win_st* %20, %_win_st** %win, align 8
  %self20 = load %ViWin*, %ViWin** %self1, align 8
  %win21 = load %_win_st*, %_win_st** %win, align 8
  %22 = getelementptr inbounds %ViWin, %ViWin* %self20, i32 0, i32 0
  store %_win_st* %win21, %_win_st** %22, align 8
  %self22 = load %ViWin*, %ViWin** %self1, align 8
  %23 = getelementptr inbounds %ViWin, %ViWin* %self22, i32 0, i32 0
  %24 = load %_win_st*, %_win_st** %23, align 8
  %25 = call i32 @keypad(%_win_st* %24, i1 true)
...
define void @ViWin_finalize(%ViWin* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
  ...
  %eqtmpX = icmp eq %ViWin* %self2, null
...
cond_end:                                         ; preds = %entry
  ...
  %5 = getelementptr inbounds %ViWin, %ViWin* %self3, i32 0, i32 0
...
define void @ViWin_view(%ViWin* %self, %Vi* %nvi) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
  ...
  %6 = call i32 @werase(%_win_st* %5)
  %self4 = load %ViWin*, %ViWin** %self1, align 8
  %7 = getelementptr inbounds %ViWin, %ViWin* %self4, i32 0, i32 1
  %8 = load %list__intp*, %list__intp** %7, align 8
  call void @"list_each_intp3_vi++01init"(%list__intp* %8, void (i32*, i32, i1*)* @"vi++01init_lambda0")
  %self5 = load %ViWin*, %ViWin** %self1, align 8
  %9 = getelementptr inbounds %ViWin, %ViWin* %self5, i32 0, i32 0
  %10 = load %_win_st*, %_win_st** %9, align 8
  %11 = call i32 @wrefresh(%_win_st* %10)
  %12 = bitcast [8192 x i8*]* %lvtable to i8*
  %13 = call i8* @xmemcpy(i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i8* %12, i64 65536)
  ret void
}

define void @ViWin_input(%ViWin* %self, %Vi* %nvi) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define i1 @ViWin_equals(%ViWin* %left, %ViWin* %right) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
  %left1 = alloca %ViWin*
  store %ViWin* %left, %ViWin** %left1, align 8
  %2 = bitcast %ViWin** %left1 to i8*
  store i8* %2, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 380), align 8
  %right2 = alloca %ViWin*
  store %ViWin* %right, %ViWin** %right2, align 8
  %3 = bitcast %ViWin** %right2 to i8*
  store i8* %3, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 381), align 8
  %left3 = load %ViWin*, %ViWin** %left1, align 8
  %right4 = load %ViWin*, %ViWin** %right2, align 8
  %eqtmpX = icmp eq %ViWin* %left3, %right4
  %4 = bitcast [8192 x i8*]* %lvtable to i8*
  %5 = call i8* @xmemcpy(i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i8* %4, i64 65536)
  ret i1 %eqtmpX
}

define void @Vi_init_curses(%Vi* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define %Vi* @Vi_initialize(%Vi* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
  ...
  %3 = call i8* @debug_xcalloc(i64 1, i64 24, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @global_string.14, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @global_string.15, i32 0, i32 0), i32 74, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @global_string.16, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @global_string.17, i32 0, i32 0))
  %4 = bitcast i8* %3 to %list__ViWinp*
  %5 = call %list__ViWinp* @"list_initialize_ViWinp4_vi++01init"(%list__ViWinp* %4)
  %6 = getelementptr inbounds %Vi, %Vi* %self3, i32 0, i32 0
  %7 = load %list__ViWinp*, %list__ViWinp** %6, align 8
  %8 = ptrtoint %list__ViWinp* %7 to i64
  %9 = icmp ne i64 %8, 0
...
cond_end:                                         ; preds = %cond_then_block, %entry
  call void @"list_finalize_ViWinp5_vi++01init"(%list__ViWinp* %7)
  %10 = bitcast %list__ViWinp* %7 to i8*
  call void @xfree(i8* %10)
  store %list__ViWinp* %5, %list__ViWinp** %6, align 8
  %11 = call i32 @xgetmaxx()
  %maxx = alloca i32
  %12 = bitcast i32* %maxx to i8*
  store i8* %12, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 381), align 8
  store i32 %11, i32* %maxx, align 4
  %13 = call i32 @xgetmaxy()
  %maxy = alloca i32
  %14 = bitcast i32* %maxy to i8*
  store i8* %14, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 382), align 8
  store i32 %13, i32* %maxy, align 4
  %15 = call i8* @debug_xcalloc(i64 1, i64 136, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @global_string.18, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @global_string.19, i32 0, i32 0), i32 79, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @global_string.20, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @global_string.21, i32 0, i32 0))
  %16 = bitcast i8* %15 to %ViWin*
  %maxx4 = load i32, i32* %maxx, align 4
  %subttmp = sub nsw i32 %maxx4, 1
  %maxy5 = load i32, i32* %maxy, align 4
  %17 = call %ViWin* @ViWin_initialize-15(%ViWin* %16, i32 0, i32 0, i32 %subttmp, i32 %maxy5)
  %win = alloca %ViWin*
  %18 = bitcast %ViWin** %win to i8*
  store i8* %18, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 383), align 8
  store %ViWin* %17, %ViWin** %win, align 8
  %win6 = load %ViWin*, %ViWin** %win, align 8
  %19 = getelementptr inbounds %ViWin, %ViWin* %win6, i32 0, i32 1
  %20 = load %list__intp*, %list__intp** %19, align 8
  %21 = call i32* @wstring(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @global_string.22, i32 0, i32 0))
  call void @"list_push_back_intp21_vi++01init"(%list__intp* %20, i32* %21)
  %win7 = load %ViWin*, %ViWin** %win, align 8
  %22 = getelementptr inbounds %ViWin, %ViWin* %win7, i32 0, i32 1
  %23 = load %list__intp*, %list__intp** %22, align 8
  %24 = call i32* @wstring(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @global_string.35, i32 0, i32 0))
  call void @"list_push_back_intp22_vi++01init"(%list__intp* %23, i32* %24)
  %win8 = load %ViWin*, %ViWin** %win, align 8
  %25 = getelementptr inbounds %ViWin, %ViWin* %win8, i32 0, i32 1
  %26 = load %list__intp*, %list__intp** %25, align 8
  %27 = call i32* @wstring(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @global_string.48, i32 0, i32 0))
  call void @"list_push_back_intp23_vi++01init"(%list__intp* %26, i32* %27)
  %self9 = load %Vi*, %Vi** %self1, align 8
  %win10 = load %ViWin*, %ViWin** %win, align 8
  %28 = getelementptr inbounds %Vi, %Vi* %self9, i32 0, i32 1
  store %ViWin* %win10, %ViWin** %28, align 8
  %self11 = load %Vi*, %Vi** %self1, align 8
  %29 = getelementptr inbounds %Vi, %Vi* %self11, i32 0, i32 0
  %30 = load %list__ViWinp*, %list__ViWinp** %29, align 8
  %win12 = load %ViWin*, %ViWin** %win, align 8
  call void @"list_push_back_ViWinp24_vi++01init"(%list__ViWinp* %30, %ViWin* %win12)
  %self13 = load %Vi*, %Vi** %self1, align 8
  %31 = bitcast [8192 x i8*]* %lvtable to i8*
  %32 = call i8* @xmemcpy(i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i8* %31, i64 65536)
  ret %Vi* %self13
}

define void @Vi_finalize(%Vi* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define i32 @Vi_main_loop(%Vi* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
  ...
  store i8* %2, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 380), align 8
  %self2 = load %Vi*, %Vi** %self1, align 8
  %3 = getelementptr inbounds %Vi, %Vi* %self2, i32 0, i32 0
  %4 = load %list__ViWinp*, %list__ViWinp** %3, align 8
  call void @"list_each_ViWinp25_vi++01init"(%list__ViWinp* %4, void (%ViWin*, i32, i1*)* @"vi++01init_lambda1")
  %self3 = load %Vi*, %Vi** %self1, align 8
  %5 = getelementptr inbounds %Vi, %Vi* %self3, i32 0, i32 1
  %6 = load %ViWin*, %ViWin** %5, align 8
  %self4 = load %Vi*, %Vi** %self1, align 8
  call void @ViWin_input-12(%ViWin* %6, %Vi* %self4)
  %7 = bitcast [8192 x i8*]* %lvtable to i8*
  %8 = call i8* @xmemcpy(i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i8* %7, i64 65536)
  ret i32 1
}
...
define %list__intp* @"list_initialize_intp0_vi++01init"(%list__intp* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define void @"list_finalize_intp1_vi++01init"(%list__intp* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
cond_jump_then5:                                  ; preds = %cond_then_block
  %10 = load i8*, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 387), align 8
...
define void @"vi++01init_lambda0"(i32* %it, i32 %it2, i1* %it3) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
  ...
  %7 = getelementptr inbounds %ViWin, %ViWin* %self, i32 0, i32 0
  %8 = load %_win_st*, %_win_st** %7, align 8
  %it24 = load i32, i32* %it22, align 4
  %it5 = load i32*, i32** %it1, align 8
  %9 = call i8* @wstring_to_string(i32* %it5, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @global_string.13, i32 0, i32 0))
  %10 = call i32 (%_win_st*, i32, i32, i8*, ...) @mvwprintw(%_win_st* %8, i32 %it24, i32 0, i8* %9)
...
define void @"list_each_intp3_vi++01init"(%list__intp* %self, void (i32*, i32, i1*)* %block_) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define %list__ViWinp* @"list_initialize_ViWinp4_vi++01init"(%list__ViWinp* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define void @"list_finalize_ViWinp5_vi++01init"(%list__ViWinp* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
cond_end11:                                       ; preds = %cond_then_block10, %cond_then_block8
  call void @"list_finalize_intp6_vi++01init"(%list__intp* %30)
...
cond_end13:                                       ; preds = %cond_then_block12, %cond_end11
  call void @"list_finalize_listp8_vi++01init"(%list__listp__intp* %36)
...
cond_end15:                                       ; preds = %cond_then_block14, %cond_end13
  call void @"list_finalize_int12_vi++01init"(%list__int* %41)
...
cond_end17:                                       ; preds = %cond_then_block16, %cond_end15
  call void @"list_finalize_int14_vi++01init"(%list__int* %46)
...
cond_end19:                                       ; preds = %cond_then_block18, %cond_end17
  call void @"list_finalize_int16_vi++01init"(%list__int* %51)
...
cond_end23:                                       ; preds = %cond_then_block22, %cond_end21
  call void @"vector_finalize_int18_vi++01init"(%vector__int* %60)
...
cond_end25:                                       ; preds = %cond_then_block24, %cond_end23
  call void @"vector_finalize_int19_vi++01init"(%vector__int* %65)
...
define void @"list_finalize_intp6_vi++01init"(%list__intp* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define void @"list_finalize_listp8_vi++01init"(%list__listp__intp* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
cond_end9:                                        ; preds = %cond_then_block8, %cond_jump_then5
  call void @"list_finalize_intp9_vi++01init"(%list__intp* %14)
...
define void @"list_finalize_intp9_vi++01init"(%list__intp* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define void @"list_finalize_int12_vi++01init"(%list__int* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define void @"list_finalize_int14_vi++01init"(%list__int* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define void @"list_finalize_int16_vi++01init"(%list__int* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define void @"vector_finalize_int18_vi++01init"(%vector__int* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define void @"vector_finalize_int19_vi++01init"(%vector__int* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define void @"list_push_back_intp21_vi++01init"(%list__intp* %self, i32* %item) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
cond_jump_then:                                   ; preds = %entry
  %6 = call i8* @debug_xcalloc(i64 1, i64 24, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @global_string.23, i32 0, i32 0), i8* getelementptr inbounds ([28 x i8], [28 x i8]* @global_string.24, i32 0, i32 0), i32 693, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @global_string.25, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @global_string.26, i32 0, i32 0))
...
"cond_jump_elif_then0\0A":                        ; preds = %"cond_jump_elif0\0A"
  %22 = call i8* @debug_xcalloc(i64 1, i64 24, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @global_string.27, i32 0, i32 0), i8* getelementptr inbounds ([28 x i8], [28 x i8]* @global_string.28, i32 0, i32 0), i32 702, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @global_string.29, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @global_string.30, i32 0, i32 0))
...
cond_else_block:                                  ; preds = %"cond_jump_elif0\0A"
  %42 = call i8* @debug_xcalloc(i64 1, i64 24, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @global_string.31, i32 0, i32 0), i8* getelementptr inbounds ([28 x i8], [28 x i8]* @global_string.32, i32 0, i32 0), i32 712, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @global_string.33, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @global_string.34, i32 0, i32 0))
...
define void @"list_push_back_intp22_vi++01init"(%list__intp* %self, i32* %item) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
cond_jump_then:                                   ; preds = %entry
  %6 = call i8* @debug_xcalloc(i64 1, i64 24, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @global_string.36, i32 0, i32 0), i8* getelementptr inbounds ([28 x i8], [28 x i8]* @global_string.37, i32 0, i32 0), i32 693, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @global_string.38, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @global_string.39, i32 0, i32 0))
  %7 = bitcast i8* %6 to %list_item__intp*
  %litem = alloca %list_item__intp*
  %8 = bitcast %list_item__intp** %litem to i8*
  store i8* %8, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 386), align 8
...
"cond_jump_elif_then0\0A":                        ; preds = %"cond_jump_elif0\0A"
  %22 = call i8* @debug_xcalloc(i64 1, i64 24, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @global_string.40, i32 0, i32 0), i8* getelementptr inbounds ([28 x i8], [28 x i8]* @global_string.41, i32 0, i32 0), i32 702, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @global_string.42, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @global_string.43, i32 0, i32 0))
  %23 = bitcast i8* %22 to %list_item__intp*
  %litem14 = alloca %list_item__intp*
  %24 = bitcast %list_item__intp** %litem14 to i8*
  store i8* %24, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 386), align 8
...
cond_else_block:                                  ; preds = %"cond_jump_elif0\0A"
  %42 = call i8* @debug_xcalloc(i64 1, i64 24, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @global_string.44, i32 0, i32 0), i8* getelementptr inbounds ([28 x i8], [28 x i8]* @global_string.45, i32 0, i32 0), i32 712, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @global_string.46, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @global_string.47, i32 0, i32 0))
  %43 = bitcast i8* %42 to %list_item__intp*
  %litem24 = alloca %list_item__intp*
  %44 = bitcast %list_item__intp** %litem24 to i8*
  store i8* %44, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 386), align 8
...
define void @"list_push_back_intp23_vi++01init"(%list__intp* %self, i32* %item) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
cond_jump_then:                                   ; preds = %entry
  %6 = call i8* @debug_xcalloc(i64 1, i64 24, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @global_string.49, i32 0, i32 0), i8* getelementptr inbounds ([28 x i8], [28 x i8]* @global_string.50, i32 0, i32 0), i32 693, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @global_string.51, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @global_string.52, i32 0, i32 0))
  %7 = bitcast i8* %6 to %list_item__intp*
  %litem = alloca %list_item__intp*
  %8 = bitcast %list_item__intp** %litem to i8*
  store i8* %8, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 386), align 8
...
"cond_jump_elif_then0\0A":                        ; preds = %"cond_jump_elif0\0A"
  %22 = call i8* @debug_xcalloc(i64 1, i64 24, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @global_string.53, i32 0, i32 0), i8* getelementptr inbounds ([28 x i8], [28 x i8]* @global_string.54, i32 0, i32 0), i32 702, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @global_string.55, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @global_string.56, i32 0, i32 0))
  %23 = bitcast i8* %22 to %list_item__intp*
  %litem14 = alloca %list_item__intp*
  %24 = bitcast %list_item__intp** %litem14 to i8*
  store i8* %24, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 386), align 8
...
cond_else_block:                                  ; preds = %"cond_jump_elif0\0A"
  %42 = call i8* @debug_xcalloc(i64 1, i64 24, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @global_string.57, i32 0, i32 0), i8* getelementptr inbounds ([28 x i8], [28 x i8]* @global_string.58, i32 0, i32 0), i32 712, i8* getelementptr inbounds ([28 x i8], [28 x i8]* @global_string.59, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @global_string.60, i32 0, i32 0))
  %43 = bitcast i8* %42 to %list_item__intp*
  %litem24 = alloca %list_item__intp*
  %44 = bitcast %list_item__intp** %litem24 to i8*
  store i8* %44, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 386), align 8
...
define void @"list_push_back_ViWinp24_vi++01init"(%list__ViWinp* %self, %ViWin* %item) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define void @"vi++01init_lambda1"(%ViWin* %it, i32 %it2, i1* %it3) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define void @"list_each_ViWinp25_vi++01init"(%list__ViWinp* %self, void (%ViWin*, i32, i1*)* %block_) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
