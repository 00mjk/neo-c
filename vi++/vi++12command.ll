; ModuleID = 'Module vi++12command'
source_filename = "Module vi++12command"
...
@global_string = private constant [4 x i8] c":%s\00", align 1
@global_string.1 = private constant [3 x i8] c"%c\00", align 1
@global_string.2 = private constant [1 x i8] zeroinitializer, align 1
@global_string.3 = private constant [2 x i8] c"w\00", align 1
@global_string.4 = private constant [2 x i8] c"q\00", align 1
@global_string.5 = private constant [2 x i8] c"!\00", align 1
@global_string.6 = private constant [6 x i8] c"shell\00", align 1
@global_string.7 = private constant [5 x i8] c"bash\00", align 1
@global_string.8 = private constant [3 x i8] c"sp\00", align 1
...
define void @ViWin_view-12(%ViWin* %self, %Vi* %nvi) {
entry:
...
cond_jump_then:                                   ; preds = %entry
  ...
  %eqtmpX6 = icmp eq %ViWin* %self4, %7
  %andand = and i1 %eqtmpX, %eqtmpX6
...
cond_jump_then7:                                  ; preds = %cond_jump_end
  ...
  %self8 = load %ViWin*, %ViWin** %9, align 8
  %10 = load i8*, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 381), align 8
  %11 = bitcast i8* %10 to %Vi**
  %nvi9 = load %Vi*, %Vi** %11, align 8
  call void @ViWin_commandModeView-12(%ViWin* %self8, %Vi* %nvi9)
  br label %cond_end
...
cond_jump_then:                                   ; preds = %entry
  ...
  call void @ViWin_commandModeInput-12(%ViWin* %self4, %Vi* %nvi5)
  br label %cond_end
...
cond_else_block:                                  ; preds = %entry
  ...
  call void @ViWin_input-9(%ViWin* %self6, %Vi* %nvi7)
  br label %cond_end
...
define void @Vi_enterComandMode-12(%Vi* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
  ...
  %4 = call i8* @string(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @global_string.2, i32 0, i32 0))
  %5 = getelementptr inbounds %Vi, %Vi* %self3, i32 0, i32 9
...
define void @Vi_exitFromComandMode-12(%Vi* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
  ...
  store i8* %2, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 380), align 8
  %self2 = load %Vi*, %Vi** %self1, align 8
  %3 = getelementptr inbounds %Vi, %Vi* %self2, i32 0, i32 9
  %4 = load i8*, i8** %3, align 8
  %5 = call i32 @string_index(i8* %4, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @global_string.3, i32 0, i32 0), i32 -1)
  %noteqtmp = icmp ne i32 %5, -1
...
cond_jump_then:                                   ; preds = %entry
  ...
  %8 = getelementptr inbounds %Vi, %Vi* %self3, i32 0, i32 1
  %9 = load %ViWin*, %ViWin** %8, align 8
  call void @ViWin_writeFile-6(%ViWin* %9)
  br label %cond_end

cond_end:                                         ; preds = %cond_jump_then, %entry
  %self4 = load %Vi*, %Vi** %self1, align 8
  %10 = getelementptr inbounds %Vi, %Vi* %self4, i32 0, i32 9
  %11 = load i8*, i8** %10, align 8
  %12 = call i32 @string_index(i8* %11, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @global_string.4, i32 0, i32 0), i32 -1)
  %noteqtmp5 = icmp ne i32 %12, -1
  br i1 %noteqtmp5, label %cond_jump_then6, label %cond_end7
...
cond_jump_then6:                                  ; preds = %cond_end
  ...
  %self8 = load %Vi*, %Vi** %14, align 8
  %15 = getelementptr inbounds %Vi, %Vi* %self8, i32 0, i32 1
  %16 = load %ViWin*, %ViWin** %15, align 8
  %17 = getelementptr inbounds %ViWin, %ViWin* %16, i32 0, i32 15
  %18 = load i1, i1* %17, align 1
  %writed = alloca i1
  %19 = bitcast i1* %writed to i8*
  store i8* %19, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 381), align 8
  store i1 %18, i1* %writed, align 1
  %oror_result_var = alloca i1
  %writed9 = load i1, i1* %writed, align 1
  %LOGICAL_DIANEAL = icmp eq i1 %writed9, false
  store i1 %LOGICAL_DIANEAL, i1* %oror_result_var, align 1
  br i1 %LOGICAL_DIANEAL, label %cond_jump_end, label %cond_jump_then10

cond_end7:                                        ; preds = %cond_end14, %cond_end
  %self20 = load %Vi*, %Vi** %self1, align 8
  %20 = getelementptr inbounds %Vi, %Vi* %self20, i32 0, i32 9
  %21 = load i8*, i8** %20, align 8
  %22 = call i32 @string_index(i8* %21, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @global_string.6, i32 0, i32 0), i32 -1)
  %noteqtmp21 = icmp ne i32 %22, -1
  br i1 %noteqtmp21, label %cond_jump_then22, label %cond_end23

cond_jump_then10:                                 ; preds = %cond_jump_then6
  %23 = load i8*, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 380), align 8
  %24 = bitcast i8* %23 to %Vi**
  %self11 = load %Vi*, %Vi** %24, align 8
  %25 = getelementptr inbounds %Vi, %Vi* %self11, i32 0, i32 9
  %26 = load i8*, i8** %25, align 8
  %27 = call i32 @string_index(i8* %26, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @global_string.5, i32 0, i32 0), i32 -1)
  %noteqtmp12 = icmp ne i32 %27, -1
  %oror = or i1 %LOGICAL_DIANEAL, %noteqtmp12
  store i1 %oror, i1* %oror_result_var, align 1
  br label %cond_jump_end

cond_jump_end:                                    ; preds = %cond_jump_then10, %cond_jump_then6
...
cond_jump_then13:                                 ; preds = %cond_jump_end
  ...
  %self15 = load %Vi*, %Vi** %29, align 8
  %30 = getelementptr inbounds %Vi, %Vi* %self15, i32 0, i32 0
  %31 = load %list__ViWinp*, %list__ViWinp** %30, align 8
  %32 = call i32 @"list_length_ViWinp0_vi++12command"(%list__ViWinp* %31)
  %eqtmpX = icmp eq i32 %32, 1
  br i1 %eqtmpX, label %cond_jump_then16, label %cond_else_block

cond_end14:                                       ; preds = %cond_end17, %cond_jump_end
  br label %cond_end7
...
cond_jump_then16:                                 ; preds = %cond_jump_then13
  ...
  %self18 = load %Vi*, %Vi** %34, align 8
  %35 = getelementptr inbounds %Vi, %Vi* %self18, i32 0, i32 3
  store i1 true, i1* %35, align 1
  br label %cond_end17

cond_else_block:                                  ; preds = %cond_jump_then13
  %36 = load i8*, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 380), align 8
  %37 = bitcast i8* %36 to %Vi**
  %self19 = load %Vi*, %Vi** %37, align 8
  call void @Vi_closeActiveWin-6(%Vi* %self19)
  br label %cond_end17

cond_end17:                                       ; preds = %cond_else_block, %cond_jump_then16
  br label %cond_end14

cond_jump_then22:                                 ; preds = %cond_end7
  %38 = call i32 @endwin()
  %39 = call i32 @system(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @global_string.7, i32 0, i32 0))
  %40 = load i8*, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 380), align 8
  %41 = bitcast i8* %40 to %Vi**
  %self24 = load %Vi*, %Vi** %41, align 8
  call void @Vi_init_curses(%Vi* %self24)
  br label %cond_end23

cond_end23:                                       ; preds = %cond_jump_then22, %cond_end7
  %self25 = load %Vi*, %Vi** %self1, align 8
  %42 = getelementptr inbounds %Vi, %Vi* %self25, i32 0, i32 9
  %43 = load i8*, i8** %42, align 8
  %44 = call i32 @string_index(i8* %43, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @global_string.8, i32 0, i32 0), i32 -1)
  %eqtmpX26 = icmp eq i32 %44, 0
  br i1 %eqtmpX26, label %cond_jump_then27, label %cond_end28

cond_jump_then27:                                 ; preds = %cond_end23
  %45 = load i8*, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 380), align 8
  %46 = bitcast i8* %45 to %Vi**
  %self29 = load %Vi*, %Vi** %46, align 8
  call void @Vi_activateFiler-15(%Vi* %self29)
  br label %cond_end28

cond_end28:                                       ; preds = %cond_jump_then27, %cond_end23
  %self30 = load %Vi*, %Vi** %self1, align 8
  %47 = getelementptr inbounds %Vi, %Vi* %self30, i32 0, i32 4
...
define %Vi* @Vi_initialize-12(%Vi* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
  ...
  store i8* %2, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 380), align 8
  %self2 = load %Vi*, %Vi** %self1, align 8
  %3 = call %Vi* @Vi_initialize-11(%Vi* %self2)
  %self3 = load %Vi*, %Vi** %self1, align 8
  %4 = call i8* @string(i8* getelementptr inbounds ([1 x i8], [1 x i8]* @global_string.9, i32 0, i32 0))
  %5 = getelementptr inbounds %Vi, %Vi* %self3, i32 0, i32 9
  %6 = load i8*, i8** %5, align 8
  %7 = ptrtoint i8* %6 to i64
  %8 = icmp ne i64 %7, 0
...
cond_end:                                         ; preds = %cond_then_block, %entry
  ...
  store i8* %4, i8** %5, align 8
  %self4 = load %Vi*, %Vi** %self1, align 8
  %9 = getelementptr inbounds %Vi, %Vi* %self4, i32 0, i32 2
  %10 = load %vector__lambdap*, %vector__lambdap** %9, align 8
  %11 = call i1 @"vector_replace_lambdap1_vi++12command"(%vector__lambdap* %10, i32 58, void (%Vi*, i32)* @"vi++12command_lambda0")
...
define void @Vi_activateFiler-12(%Vi* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define void @ViWin_commandModeView-12(%ViWin* %self, %Vi* %nvi) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
  ...
  %11 = getelementptr inbounds %Vi, %Vi* %nvi8, i32 0, i32 9
  %12 = load i8*, i8** %11, align 8
  %13 = call i32 (%_win_st*, i32, i32, i8*, ...) @mvwprintw(%_win_st* %8, i32 %subttmp, i32 0, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @global_string, i32 0, i32 0), i8* %12)
...
define void @ViWin_commandModeInput-12(%ViWin* %self, %Vi* %nvi) {
entry:
  %result_variable = alloca i8*
  %value = alloca i32
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
  ...
  %eqtmpY = icmp eq i32 %key4, 10
  br i1 %eqtmpY, label %cond_then_block, label %cond_else_block

end_block:                                        ; preds = %cond_else_block23, %cond_end31, %cond_then_block13, %cond_then_block6, %cond_then_block
...
cond_then_block:                                  ; preds = %entry
  %nvi5 = load %Vi*, %Vi** %nvi2, align 8
  call void @Vi_exitFromComandMode-12(%Vi* %nvi5)
  br label %end_block
...
cond_then_block6:                                 ; preds = %cond_else_block7, %cond_else_block
  %nvi11 = load %Vi*, %Vi** %nvi2, align 8
  %8 = getelementptr inbounds %Vi, %Vi* %nvi11, i32 0, i32 4
  store i32 0, i32* %8, align 4
  br label %end_block

cond_else_block7:                                 ; preds = %cond_else_block
  %eqtmpY10 = icmp eq i32 %key4, 27
  br i1 %eqtmpY10, label %cond_then_block6, label %cond_else_block9

cond_else_block9:                                 ; preds = %after_break12, %cond_else_block7
  %eqtmpY15 = icmp eq i32 %key4, 8
  br i1 %eqtmpY15, label %cond_then_block13, label %cond_else_block14

after_break12:                                    ; No predecessors!
  br label %cond_else_block9

cond_then_block13:                                ; preds = %cond_else_block16, %cond_else_block14, %cond_else_block9
  %nvi20 = load %Vi*, %Vi** %nvi2, align 8
  %9 = getelementptr inbounds %Vi, %Vi* %nvi20, i32 0, i32 9
  %10 = load i8*, i8** %9, align 8
  %11 = call i8* @string_delete(i8* %10, i32 -1)
  br label %end_block

cond_else_block14:                                ; preds = %cond_else_block9
  %eqtmpY17 = icmp eq i32 %key4, 127
  br i1 %eqtmpY17, label %cond_then_block13, label %cond_else_block16

cond_else_block16:                                ; preds = %cond_else_block14
  %eqtmpY19 = icmp eq i32 %key4, 263
  br i1 %eqtmpY19, label %cond_then_block13, label %cond_else_block18

cond_else_block18:                                ; preds = %after_break21, %cond_else_block16
  br label %cond_then_block22

after_break21:                                    ; No predecessors!
  br label %cond_else_block18

cond_then_block22:                                ; preds = %cond_else_block18
  %nvi24 = load %Vi*, %Vi** %nvi2, align 8
  %nvi25 = load %Vi*, %Vi** %nvi2, align 8
  %12 = getelementptr inbounds %Vi, %Vi* %nvi25, i32 0, i32 9
  %13 = load i8*, i8** %12, align 8
  %key26 = load i32, i32* %key, align 4
  store i32 %key26, i32* %value, align 4
  br label %to_string

cond_else_block23:                                ; preds = %after_break32
  br label %end_block

to_string:                                        ; preds = %cond_then_block22
  %14 = bitcast i32* %value to i8*
  store i8* %14, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 383), align 8
  %value27 = load i32, i32* %value, align 4
  %15 = call i8* (i8*, ...) @xasprintf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @global_string.1, i32 0, i32 0), i32 %value27)
  store i8* %15, i8** %result_variable, align 8
  br label %inline_func_end

inline_func_end:                                  ; preds = %to_string
  %result_variable28 = load i8*, i8** %result_variable, align 8
  %16 = call i8* @op_add_string_string(i8* %13, i8* %result_variable28)
  %17 = getelementptr inbounds %Vi, %Vi* %nvi24, i32 0, i32 9
  %18 = load i8*, i8** %17, align 8
  %19 = ptrtoint i8* %18 to i64
  %20 = icmp ne i64 %19, 0
  br i1 %20, label %cond_then_block29, label %cond_end

cond_then_block29:                                ; preds = %inline_func_end
  br label %cond_end

cond_end:                                         ; preds = %cond_then_block29, %inline_func_end
  call void @xfree(i8* %18)
  store i8* %16, i8** %17, align 8
  %21 = ptrtoint i8* %result_variable28 to i64
  %22 = icmp ne i64 %21, 0
  br i1 %22, label %cond_then_block30, label %cond_end31

cond_then_block30:                                ; preds = %cond_end
  br label %cond_end31

cond_end31:                                       ; preds = %cond_then_block30, %cond_end
  call void @xfree(i8* %result_variable28)
  br label %end_block
...
define i32 @"list_length_ViWinp0_vi++12command"(%list__ViWinp* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
  ...
  %3 = getelementptr inbounds %list__ViWinp, %list__ViWinp* %self2, i32 0, i32 2
...
define void @"vi++12command_lambda0"(%Vi* %self, i32 %key) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
  ...
  %self3 = load %Vi*, %Vi** %self1, align 8
  call void @Vi_enterComandMode-12(%Vi* %self3)
  %4 = bitcast [8192 x i8*]* %lvtable to i8*
  %5 = call i8* @xmemcpy(i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i8* %4, i64 65536)
  ret void
}

define i1 @"vector_replace_lambdap1_vi++12command"(%vector__lambdap* %self, i32 %index, void (%Vi*, i32)* %value) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
