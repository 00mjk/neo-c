; ModuleID = 'Module tiny01init'
source_filename = "Module tiny01init"
...
@global_string = private constant [8 x i8] c"buffer%\00", align 1
@global_string.1 = private constant [14 x i8] c"tiny01init.nc\00", align 1
@global_string.2 = private constant [11 x i8] c"initialize\00", align 1
@global_string.3 = private constant [22 x i8] c"TinyParser_initialize\00", align 1
...
define %TinyParser* @TinyParser_initialize(%TinyParser* %self, i8* %source_name) {
entry:
  ...
  %4 = call i8* @string(i8* %source_name4)
  %5 = getelementptr inbounds %TinyParser, %TinyParser* %self3, i32 0, i32 0
...
cond_end:                                         ; preds = %cond_then_block, %entry
  ...
  %9 = getelementptr inbounds %TinyParser, %TinyParser* %self5, i32 0, i32 1
  store i32 1, i32* %9, align 4
  %self6 = load %TinyParser*, %TinyParser** %self1, align 8
  %10 = call i8* @debug_xcalloc(i64 1, i64 16, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @global_string, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @global_string.1, i32 0, i32 0), i32 8, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @global_string.2, i32 0, i32 0), i8* getelementptr inbounds ([22 x i8], [22 x i8]* @global_string.3, i32 0, i32 0))
  %11 = bitcast i8* %10 to %buffer*
  %12 = call %buffer* @buffer_initialize(%buffer* %11)
  %13 = getelementptr inbounds %TinyParser, %TinyParser* %self6, i32 0, i32 2
...
cond_end8:                                        ; preds = %cond_then_block7, %cond_end
  ...
  store %buffer* %12, %buffer** %13, align 8
  %source_name9 = load i8*, i8** %source_name2, align 8
  %18 = call %_IO_FILE* @fopen(i8* %source_name9, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @global_string.4, i32 0, i32 0))
  %f = alloca %_IO_FILE*
  %19 = bitcast %_IO_FILE** %f to i8*
  store i8* %19, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 367), align 8
  store %_IO_FILE* %18, %_IO_FILE** %f, align 8
  %f10 = load %_IO_FILE*, %_IO_FILE** %f, align 8
  %20 = ptrtoint %_IO_FILE* %f10 to i64
  %21 = icmp ne i64 %20, 0
  br i1 %21, label %cond_jump_then, label %cond_end11

cond_jump_then:                                   ; preds = %cond_end8
  %line = alloca i8*
  %22 = bitcast i8** %line to i8*
  store i8* %22, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 368), align 8
  %element_memory = alloca i8, i32 4096
  store i8* %element_memory, i8** %line, align 8
  br label %loop_top_block

cond_end11:                                       ; preds = %cond_end_block, %cond_end8
  %f22 = load %_IO_FILE*, %_IO_FILE** %f, align 8
  %23 = call i32 @fclose(%_IO_FILE* %f22)
  %self23 = load %TinyParser*, %TinyParser** %self1, align 8
  %self24 = load %TinyParser*, %TinyParser** %self1, align 8
  %24 = getelementptr inbounds %TinyParser, %TinyParser* %self24, i32 0, i32 2
  %25 = load %buffer*, %buffer** %24, align 8
  %26 = getelementptr inbounds %buffer, %buffer* %25, i32 0, i32 0
  %27 = load i8*, i8** %26, align 8
  %28 = getelementptr inbounds %TinyParser, %TinyParser* %self23, i32 0, i32 3
  store i8* %27, i8** %28, align 8
  %self25 = load %TinyParser*, %TinyParser** %self1, align 8
  %29 = bitcast [8192 x i8*]* %lvtable to i8*
  %30 = call i8* @xmemcpy(i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i8* %29, i64 65536)
  ret %TinyParser* %self25

loop_top_block:                                   ; preds = %cond_then_block14, %cond_jump_then
  %line12 = load i8*, i8** %line, align 8
  %31 = load i8*, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 367), align 8
  %32 = bitcast i8* %31 to %_IO_FILE**
  %f13 = load %_IO_FILE*, %_IO_FILE** %32, align 8
  %33 = call i8* @fgets(i8* %line12, i32 4096, %_IO_FILE* %f13)
  %noteqtmp = icmp ne i8* %33, null
  br i1 %noteqtmp, label %cond_then_block14, label %cond_end_block

cond_then_block14:                                ; preds = %loop_top_block
  %34 = load i8*, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 368), align 8
  %35 = bitcast i8* %34 to i8**
  %line15 = load i8*, i8** %35, align 8
  %36 = load i8*, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 368), align 8
  %37 = bitcast i8* %36 to i8**
  %line16 = load i8*, i8** %37, align 8
  %38 = call i64 @strlen(i8* %line16)
  %subttmp = sub nsw i64 %38, 1
  %39 = trunc i64 %subttmp to i32
  %element_address = getelementptr i8, i8* %line15, i64 %subttmp
  store i8 10, i8* %element_address, align 1
  %40 = load i8*, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 368), align 8
  %41 = bitcast i8* %40 to i8**
  %line17 = load i8*, i8** %41, align 8
  %42 = load i8*, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 368), align 8
  %43 = bitcast i8* %42 to i8**
  %line18 = load i8*, i8** %43, align 8
  %44 = call i64 @strlen(i8* %line18)
  %45 = trunc i64 %44 to i32
  %element_address19 = getelementptr i8, i8* %line17, i64 %44
  store i8 0, i8* %element_address19, align 1
  %46 = load i8*, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 365), align 8
  %47 = bitcast i8* %46 to %TinyParser**
  %self20 = load %TinyParser*, %TinyParser** %47, align 8
  %48 = getelementptr inbounds %TinyParser, %TinyParser* %self20, i32 0, i32 2
  %49 = load %buffer*, %buffer** %48, align 8
  %50 = load i8*, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 368), align 8
  %51 = bitcast i8* %50 to i8**
  %line21 = load i8*, i8** %51, align 8
  call void @buffer_append_str(%buffer* %49, i8* %line21)
  br label %loop_top_block
...
define void @TinyParser_debug(%TinyParser* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
  ...
  %3 = getelementptr inbounds %TinyParser, %TinyParser* %self2, i32 0, i32 2
  %4 = load %buffer*, %buffer** %3, align 8
  %5 = getelementptr inbounds %buffer, %buffer* %4, i32 0, i32 0
  %6 = load i8*, i8** %5, align 8
