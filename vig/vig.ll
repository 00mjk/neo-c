...
%win = type { %_win_st*, %list_char*, i32, i32, i32, i32 }
...
entry:
  ...
  store i8* %4, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 21), align 8
  store %winsize* %3, %winsize** %ws, align 8
  %ws1 = load %winsize*, %winsize** %ws, align 8
  %5 = call i32 (i32, i32, ...) @ioctl(i32 1, i32 21523, %winsize* %ws1)
...
define %win* @win_initialize(%win* %self, i32 %y, i32 %x, i32 %width, i32 %height) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @ncmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
  ...
  store i8* %4, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 23), align 8
  %width4 = alloca i32
  store i32 %width, i32* %width4, align 4
  %5 = bitcast i32* %width4 to i8*
  store i8* %5, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 24), align 8
  %height5 = alloca i32
  store i32 %height, i32* %height5, align 4
  %6 = bitcast i32* %height5 to i8*
  store i8* %6, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 25), align 8
  %self6 = load %win*, %win** %self1, align 8
  %7 = getelementptr inbounds %win, %win* %self6, i32 0, i32 0
  %8 = load %_win_st*, %_win_st** %7, align 8
  %9 = call i32 @keypad(%_win_st* %8, i1 false)
  %self7 = load %win*, %win** %self1, align 8
  %10 = call i8* @nccalloc(i32 1, i64 48)
  %11 = bitcast i8* %10 to %list_char*
  %12 = call %list_char* @list_initialize_charp0_vig(%list_char* %11)
  %13 = getelementptr inbounds %win, %win* %self7, i32 0, i32 1
  %14 = load %list_char*, %list_char** %13, align 8
  call void @list_finalize_charp1_vig(%list_char* %14)
  %15 = bitcast %list_char* %14 to i8*
  call void @ncfree(i8* %15)
  store %list_char* %12, %list_char** %13, align 8
  %self8 = load %win*, %win** %self1, align 8
  %y9 = load i32, i32* %y2, align 4
  %16 = getelementptr inbounds %win, %win* %self8, i32 0, i32 2
  store i32 %y9, i32* %16, align 4
  %self10 = load %win*, %win** %self1, align 8
  %x11 = load i32, i32* %x3, align 4
  %17 = getelementptr inbounds %win, %win* %self10, i32 0, i32 3
  store i32 %x11, i32* %17, align 4
  %self12 = load %win*, %win** %self1, align 8
  %width13 = load i32, i32* %width4, align 4
  %18 = getelementptr inbounds %win, %win* %self12, i32 0, i32 4
  store i32 %width13, i32* %18, align 4
  %self14 = load %win*, %win** %self1, align 8
  %height15 = load i32, i32* %height5, align 4
  %19 = getelementptr inbounds %win, %win* %self14, i32 0, i32 5
  store i32 %height15, i32* %19, align 4
  %width16 = load i32, i32* %width4, align 4
  %height17 = load i32, i32* %height5, align 4
  %y18 = load i32, i32* %y2, align 4
  %x19 = load i32, i32* %x3, align 4
  %20 = call %_win_st* @newwin(i32 %width16, i32 %height17, i32 %y18, i32 %x19)
  %win = alloca %_win_st*
  %21 = bitcast %_win_st** %win to i8*
  store i8* %21, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 26), align 8
  store %_win_st* %20, %_win_st** %win, align 8
  %self20 = load %win*, %win** %self1, align 8
  %win21 = load %_win_st*, %_win_st** %win, align 8
  %22 = getelementptr inbounds %win, %win* %self20, i32 0, i32 0
  store %_win_st* %win21, %_win_st** %22, align 8
  %self22 = load %win*, %win** %self1, align 8
  %23 = bitcast [8192 x i8*]* %lvtable to i8*
  %24 = call i8* @ncmemcpy(i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i8* %23, i64 65536)
  ret %win* %self22
}

define %list_char* @list_initialize_charp0_vig(%list_char* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @ncmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define void @list_finalize_charp1_vig(%list_char* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @ncmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
cond_end:                                         ; preds = %entry
  ...
  %5 = getelementptr inbounds %win, %win* %self3, i32 0, i32 0
...
entry:
  ...
  call void @list_each_charp3_vig(%list_char* %7, void (i8*, i32)* @vig_lambda0)
...
define void @vig_lambda0(i8* %it, i32 %it2) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @ncmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define void @list_each_charp3_vig(%list_char* %self, void (i8*, i32)* %block) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @ncmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define void @win_input(%win* %self, %vig* %vig) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @ncmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define void @vig_init_curses(%vig* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @ncmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
  ...
  %5 = call i32 @keypad(%_win_st* %stdscr, i1 true)
  %6 = call i32 @raw()
...
define %vig* @vig_initialize(%vig* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @ncmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
  ...
  %5 = call %vector_win* @vector_initialize_winp4_vig(%vector_win* %4)
  %6 = getelementptr inbounds %vig, %vig* %self3, i32 0, i32 0
  %7 = load %vector_win*, %vector_win** %6, align 8
  call void @vector_finalize_winp5_vig(%vector_win* %7)
  ...
  %13 = call i8* @nccalloc(i32 1, i64 32)
  ...
  call void @list_push_back_charp8_vig(%list_char* %18, i8* %19)
  ...
  call void @list_push_back_charp9_vig(%list_char* %21, i8* %22)
  ...
  call void @list_push_back_charp10_vig(%list_char* %24, i8* %25)
  ...
  call void @vector_push_back_winp11_vig(%vector_win* %28, %win* %win12)
...
define %vector_win* @vector_initialize_winp4_vig(%vector_win* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @ncmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define void @vector_finalize_winp5_vig(%vector_win* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @ncmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
cond_then_block:                                  ; preds = %loop_top_block
  ...
  call void @list_finalize_charp6_vig(%list_char* %22)
...
define void @list_finalize_charp6_vig(%list_char* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @ncmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define void @list_push_back_charp8_vig(%list_char* %self, i8* %item) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @ncmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define void @list_push_back_charp9_vig(%list_char* %self, i8* %item) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @ncmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define void @list_push_back_charp10_vig(%list_char* %self, i8* %item) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @ncmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define void @vector_push_back_winp11_vig(%vector_win* %self, %win* %item) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @ncmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define void @vig_finalize(%vig* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @ncmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define i32 @vig_main_loop(%vig* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @ncmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
  ...
  %self2 = load %vig*, %vig** %self1, align 8
  %4 = getelementptr inbounds %vig, %vig* %self2, i32 0, i32 0
  %5 = load %vector_win*, %vector_win** %4, align 8
  call void @vector_each_winp12_vig(%vector_win* %5, void (%win*, i32)* @vig_lambda1)
  %self3 = load %vig*, %vig** %self1, align 8
  %6 = getelementptr inbounds %vig, %vig* %self3, i32 0, i32 1
  %7 = load %win*, %win** %6, align 8
  %self4 = load %vig*, %vig** %self1, align 8
  call void @win_input(%win* %7, %vig* %self4)
  %8 = bitcast [8192 x i8*]* %lvtable to i8*
  %9 = call i8* @ncmemcpy(i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i8* %8, i64 65536)
  ret i32 1
}

define void @vig_lambda1(%win* %it, i32 %it2) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @ncmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
