...
declare void @win_view-2(%win*)

declare void @win_input-2(%win*, %vig*)

declare i8* @win_getCursorLine(%win*)

declare i32 @win_getCursorLineLength(%win*)

declare void @win_forward(%win*)

declare void @win_backward(%win*)

declare %vig* @vig_initialize-2(%vig*)

declare i32 @vig_main_loop-2(%vig*)
...
entry:
  ...
  %2 = call i8* @nccalloc(i32 1, i64 32)
  %3 = bitcast i8* %2 to %vig*
  %4 = call %vig* @vig_initialize-2(%vig* %3)
  %vig = alloca %vig*
  %5 = bitcast %vig** %vig to i8*
  store i8* %5, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 14), align 8
  store %vig* %4, %vig** %vig, align 8
  %vig1 = load %vig*, %vig** %vig, align 8
  %6 = call i32 @vig_main_loop-2(%vig* %vig1)
  %7 = load %vig*, %vig** %vig, align 8
  %8 = getelementptr inbounds %vig, %vig* %7, i32 0, i32 0
  ...
  %11 = getelementptr inbounds %vig, %vig* %7, i32 0, i32 2
  %12 = load %vector_lambda*, %vector_lambda** %11, align 8
  call void @vector_finalize_lambda3_main(%vector_lambda* %12)
  %13 = bitcast %vector_lambda* %12 to i8*
  call void @ncfree(i8* %13)
  call void @vig_finalize(%vig* %7)
  %14 = bitcast %vig* %7 to i8*
...
define void @vector_finalize_lambda3_main(%vector_lambda* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @ncmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
