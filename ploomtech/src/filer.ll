...
@global_string.5 = private constant [21 x i8] c"PloomTech_initialize\00", align 1
...
@global_string.9 = private constant [21 x i8] c"PloomTech_initialize\00", align 1
...
define %PloomTech* @PloomTech_initialize(%PloomTech* %self) {
entry:
  ...
  %self1 = alloca %PloomTech*
  store %PloomTech* %self, %PloomTech** %self1, align 8
  %2 = bitcast %PloomTech** %self1 to i8*
...
cond_jump_then:                                   ; preds = %entry
  ...
  %10 = bitcast i8* %9 to %PloomTech**
  %self3 = load %PloomTech*, %PloomTech** %10, align 8
  call void @PloomTech_exit(%PloomTech* %self3)
...
cond_end15:                                       ; preds = %cond_then_block14, %cond_end7
  ...
  %self16 = load %PloomTech*, %PloomTech** %self1, align 8
  %40 = bitcast [8192 x i8*]* %lvtable to i8*
  %41 = call i8* @xxxmemcpy(i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i8* %40, i64 65536)
  ret %PloomTech* %self16
}

define void @PloomTech_finalize(%PloomTech* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xxxmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
  ...
  %2 = bitcast %PloomTech** %self1 to i8*
  store i8* %2, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 455), align 8
  %self2 = load %PloomTech*, %PloomTech** %self1, align 8
  %eqtmpX = icmp eq %PloomTech* %self2, null
  br i1 %eqtmpX, label %cond_jump_then, label %cond_end
...
cond_end:                                         ; preds = %entry
  %self3 = load %PloomTech*, %PloomTech** %self1, align 8
  call void @PloomTech_exit(%PloomTech* %self3)
...
define i1 @PloomTech_main_loop(%PloomTech* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xxxmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
loop_top_block:                                   ; preds = %cond_then_block, %entry
  %self2 = load %PloomTech*, %PloomTech** %self1, align 8
  %3 = getelementptr inbounds %PloomTech, %PloomTech* %self2, i32 0, i32 1
...
cond_then_block:                                  ; preds = %loop_top_block
  ...
  %6 = bitcast i8* %5 to %PloomTech**
  %self3 = load %PloomTech*, %PloomTech** %6, align 8
  %7 = getelementptr inbounds %PloomTech, %PloomTech* %self3, i32 0, i32 0
  %8 = load %Filer*, %Filer** %7, align 8
  call void @Filer_view(%Filer* %8)
  %9 = load i8*, i8** getelementptr inbounds ([8192 x i8*], [8192 x i8*]* @gLVTable, i32 0, i32 455), align 8
  %10 = bitcast i8* %9 to %PloomTech**
  %self4 = load %PloomTech*, %PloomTech** %10, align 8
  %11 = getelementptr inbounds %PloomTech, %PloomTech* %self4, i32 0, i32 0
...
define void @PloomTech_exit(%PloomTech* %self) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xxxmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
...
define %Filer* @Filer_initialize(%Filer* %self, i8* %path, %PloomTech* %ploomtech) {
entry:
  %lvtable = alloca [8192 x i8*]
  %0 = bitcast [8192 x i8*]* %lvtable to i8*
  %1 = call i8* @xxxmemcpy(i8* %0, i8* bitcast ([8192 x i8*]* @gLVTable to i8*), i64 65536)
  ...
  %ploomtech3 = alloca %PloomTech*
  store %PloomTech* %ploomtech, %PloomTech** %ploomtech3, align 8
  %4 = bitcast %PloomTech** %ploomtech3 to i8*
...
cond_end:                                         ; preds = %cond_then_block, %entry
  ...
  %ploomtech7 = load %PloomTech*, %PloomTech** %ploomtech3, align 8
  %10 = getelementptr inbounds %Filer, %Filer* %self6, i32 0, i32 0
  store %PloomTech* %ploomtech7, %PloomTech** %10, align 8
...
cond_then_block:                                  ; preds = %cond_else_block
  ...
  %24 = load %PloomTech*, %PloomTech** %23, align 8
  %25 = getelementptr inbounds %PloomTech, %PloomTech* %24, i32 0, i32 1
...
cond_then_block55:                                ; preds = %cond_else_block40
  ...
  %88 = load %PloomTech*, %PloomTech** %87, align 8
  %89 = getelementptr inbounds %PloomTech, %PloomTech* %88, i32 0, i32 2
...
cond_then_block68:                                ; preds = %cond_else_block56
  ...
  %111 = load %PloomTech*, %PloomTech** %110, align 8
  %112 = getelementptr inbounds %PloomTech, %PloomTech* %111, i32 0, i32 2
...
cond_then_block81:                                ; preds = %cond_else_block69
  ...
  %134 = load %PloomTech*, %PloomTech** %133, align 8
  %135 = getelementptr inbounds %PloomTech, %PloomTech* %134, i32 0, i32 2
...
cond_then_block94:                                ; preds = %cond_else_block82
  ...
  %154 = load %PloomTech*, %PloomTech** %153, align 8
  %155 = getelementptr inbounds %PloomTech, %PloomTech* %154, i32 0, i32 2
...
cond_then_block103:                               ; preds = %cond_else_block95
  ...
  %174 = load %PloomTech*, %PloomTech** %173, align 8
  %175 = getelementptr inbounds %PloomTech, %PloomTech* %174, i32 0, i32 2
...
cond_then_block116:                               ; preds = %cond_else_block104
  ...
  %197 = load %PloomTech*, %PloomTech** %196, align 8
  %198 = getelementptr inbounds %PloomTech, %PloomTech* %197, i32 0, i32 2
...
cond_then_block181:                               ; preds = %cond_else_block174
  ...
  %265 = load %PloomTech*, %PloomTech** %264, align 8
  %266 = getelementptr inbounds %PloomTech, %PloomTech* %265, i32 0, i32 2
...
!1 = !DIFile(filename: "src/filer.nc", directory: "/home/ab25cq/repo/neo-c/ploomtech")
!2 = !{}
