...
@global_string = private constant [6 x i8] c"a %d\0A\00", align 1
...
entry:
  ...
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @global_string, i32 0, i32 0), i32 %a1)
...
!1 = !DIFile(filename: "a.nc", directory: "/home/ab25cq/repo/neo-c/clover3")
!2 = !{}
